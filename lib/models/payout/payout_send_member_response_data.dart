class PayoutSendMemberResponseData {
  final bool result;
  ...
  factory PayoutSendMemberResponseData.fromJson(Map<String, dynamic> json) {
    return PayoutSendMemberResponseData(
