class PayoutSendAccountResponseData {
  final bool result;
  ...
  factory PayoutSendAccountResponseData.fromJson(Map<String, dynamic> json) {
    return PayoutSendAccountResponseData(
