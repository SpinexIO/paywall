/// Response model for Sync Cancel Rollback
class PaymentSyncCancelRollbackResponse {
  ...
  PaymentSyncCancelRollbackResponse({
  ...
  factory PaymentSyncCancelRollbackResponse.fromJson(Map<String, dynamic> json) {
    final result = json['result'] ?? json['Result'];
    return PaymentSyncCancelRollbackResponse(
