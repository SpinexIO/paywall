class GiftBalanceByIdResponseData {
  final String id;
  ...
  factory GiftBalanceByIdResponseData.fromJson(Map<String, dynamic> json) {
    return GiftBalanceByIdResponseData(
