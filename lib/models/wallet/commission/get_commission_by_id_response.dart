class CommissionByIdResponseData {
  final String id;
  final String level;
  ...
  factory CommissionByIdResponseData.fromJson(Map<String, dynamic> json) {
    return CommissionByIdResponseData(
